...
@Controller
@RequestMapping(value="/customer")//root uul
public class CustomerController {
	@Autowired
	private ICustomerService ics = null;//注入service
	...
	public String add(@ModelAttribute("cm") CustomerModel cm){//post 元素自动组成cm类
	...
	public String toList(@ModelAttribute("wm")CustomerWebModel wm,Model model){//接受jason自动放入wm变量中
...
System.out.println("cqm============="+cqm);
		...
		Page dbPage = ics.getByConditionPage(cqm);//查询条件后返回page对象
